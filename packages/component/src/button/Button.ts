const buttonStyles = `
  ...
  .in-button.primary:hover,
  .in-button.secondary:hover,
  .in-button.icon:hover {
    background: var(--color-white);
  ...
  .in-button.primary[disabled]:hover,
  .in-button.secondary[disabled]:hover,
  .in-button.icon[disabled]:hover {
    border: var(--border-disable);
    outline: none;
    box-shadow: none;
} 
